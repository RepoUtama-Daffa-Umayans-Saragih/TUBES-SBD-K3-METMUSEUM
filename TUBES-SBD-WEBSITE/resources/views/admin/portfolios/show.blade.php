    ...
    <div class="admin-section">
        ...
        <div class="admin-detail-header">
            ...
            <div class="detail-actions">
                <a href="{{ route('admin.portfolios.edit', $portfolio) }}" class="btn btn-primary">Edit</a>
        ...
        <div class="admin-detail-container">
            <div class="detail-card">
                <h3 class="detail-card-title">Portfolio Information</h3>
                <div class="detail-content">
                    <div class="detail-row">
                        <div class="detail-label">Portfolio Name</div>
                        <div class="detail-value">{{ $portfolio->portfolio_name }}</div>
                    </div>
                    <div class="detail-row">
                        <div class="detail-label">Total Artworks</div>
                        <div class="detail-value">{{ $portfolio->artWorks->count() }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-card">
                ...
                <div class="detail-content">
                    @if ($portfolio->artWorks->count())
                        <table class="admin-table">
                            <thead>
                                <tr><th>Title</th><th>Accession</th><th>Actions</th></tr>
                            </thead>
                            <tbody>
                                @foreach ($portfolio->artWorks as $artwork)
                                    <tr>
                                        <td>{{ $artwork->title }}</td>
