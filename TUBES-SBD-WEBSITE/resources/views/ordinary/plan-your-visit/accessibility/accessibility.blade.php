...
<head>
    ...
    <title>Accessibility - The Metropolitan Museum of Art</title>
    @vite(['resources/ordinary/plan-your-visit/accessibility/accessibility.css', 'resources/js/app.js'])
...
<body>
    ...
    <section class="hero-section">
        ...
        <p class="page-subtitle">
            ...
            disabilities at The Met Fifth Avenue.
        </p>
    </section>
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="contact-body">
                        <p class="mb-4">
                            ...
                            email
                            <a href="mailto:access@metmuseum.org" class="inline-link">access@metmuseum.org</a>.
                        </p>
                    </div>
        ...
        <section id="events" class="events-section">
            ...
            <div class="event-card">
                ...
                <div class="lg:order-first">
                    <h3 class="event-title">Plan a Group or School Visit</h3>
                    <p class="event-desc">
            ...
            <section class="max-w-screen-xl mx-auto px-6 md:px-10 py-16 relative group">
                <div class="flex justify-between items-end mb-8">
                    <h2 class="text-3xl font-bold">Upcoming Events</h2>
                    <a href="#" class="footer-action-link text-sm">View all <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <!-- Carousel Container -->
                <div id="carousel" class="event-carousel">

                    <!-- Card 1 -->
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-gothic.jpeg') }}" alt="Event Gothic Design"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Met Expert Talks at The Met Cloisters—Gothic Design</h3>
                        <p class="event-card-meta">May 1 &nbsp; 3:00 PM</p>
                        <p class="event-card-meta text-gray-400">The Met Cloisters</p>
                    </div>

                    <!-- Card 2 -->
                    <div class="event-card-item">
                        <img src="{{ asset('images/drop-in-draw.jpeg') }}" alt="Event Vivid Symbols"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Drop-in Drawing—Vivid Symbols</h3>
                        <p class="event-card-meta">May 1 &nbsp; 6:00 PM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue</p>
                    </div>

                    <!-- Card 3, 4, 5... (Duplikasi sesuai kebutuhan) -->
                    <div class="event-card-item">
                        <img src="{{ asset('images/silent-bookclub.jpeg') }}" alt="Event Silent Book Club"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Silent Book Club of Death NYC at The Met Cloisters</h3>
                        <p class="event-card-meta">May 2 &nbsp; 2:00 PM</p>
                        <p class="event-card-meta text-gray-400">The Met Cloisters</p>
                    </div>

                    <div class="event-card-item">
                        <img src="{{ asset('images/event-storytime.jpeg') }}" alt="Event Storytime"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Storytime at The Met Cloisters—Creatures That Fly</h3>
                        <p class="event-card-meta">May 5 &nbsp; 11:30 AM</p>
                        <p class="event-card-meta text-gray-400">The Met Cloisters</p>
                    </div>

                    <div class="event-card-item">
                        <img src="{{ asset('images/event-research.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Research Out Loud—Beyond the Image: Trans-Technical Perspectives
                        </h3>
                        <p class="event-card-meta">May 7 &nbsp; 10:30 AM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue, Online</p>
                    </div>

                    <div class="event-card-item">
                        <img src="{{ asset('images/event-research.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Research Out Loud—Amber Adornment: Working with Classical Fibulas
                        </h3>
                        <p class="event-card-meta">May 7 &nbsp; 2:00 PM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue</p>
                    </div>

                    <div class="event-card-item">
                        <img src="{{ asset('images/event-japanese.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Met Expert Talks—The Infinite Artistry of Japanese Ceramics</h3>
                        <p class="event-card-meta">May 7 &nbsp; 3:00 PM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue</p>
                    </div>
                    ...
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-research.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Research Out Loud—How Old Is This Chinese Bronze?</h3>
                        <p class="event-card-meta">May 7 &nbsp; 3:30 PM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue</p>
                    </div>
                    ...
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-research.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Research Out Loud—Body Politics: New Readings on Modern Art</h3>
                        <p class="event-card-meta">May 8 &nbsp; 10:30 AM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue, Online</p>
                    </div>
                    ...
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-research.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Research Out Loud—Building a Greek Sarcophagus</h3>
                        <p class="event-card-meta">May 8 &nbsp; 2:00 PM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue</p>
                    </div>
                    ...
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-gothic.jpeg') }}" alt="Event Gothic Design"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Met Expert Talks at The Met Cloisters—Gothic Design</h3>
                        <p class="event-card-meta">May 8 &nbsp; 3:00 PM</p>
                        <p class="event-card-meta text-gray-400">The Met Cloisters</p>
                    </div>
                    ...
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-research.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Research Out Loud—Metal Thread Revealed: Looking, Touching, Making
                        </h3>
                        <p class="event-card-meta">May 8 &nbsp; 4:00 PM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue</p>
                    </div>
                    ...
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-research.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Research Out Loud—Looking Closely at Late Medieval Sculpture</h3>
                        <p class="event-card-meta">May 8 &nbsp; 6:30 PM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue</p>
                    </div>
                    ...
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-research.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Research Out Loud—What Makes a Painting? The Colorful, Complex, and
                            Painted Surface</h3>
                        <p class="event-card-meta">May 11 &nbsp; 10:30 AM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue, Online</p>
                    </div>
                    ...
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-research.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Research Out Loud—Constructing the Panoramic View: A Conversation
                            with An-My Lê</h3>
                        <p class="event-card-meta">May 11 &nbsp; 2:00 PM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue</p>
                    </div>
                    ...
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-research.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Research Out Loud—Tortoiseshell: Faux or Genuine?</h3>
                        <p class="event-card-meta">May 11 &nbsp; 3:30 PM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue</p>
                    </div>
                    ...
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-research.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Research Out Loud—Decentering Art Histories of the Americas</h3>
                        <p class="event-card-meta">May12 &nbsp; 10:30 AM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue, Online</p>
                    </div>
                    ...
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-storytime.jpeg') }}" alt="Event Storytime"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Storytime at The Met Cloisters—Creatures That Fly</h3>
                        <p class="event-card-meta">May 12 &nbsp; 11:30 AM</p>
                        <p class="event-card-meta text-gray-400">the Met Cloisters</p>
                    </div>
                    ...
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-research.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Research Out Loud—Mosaic Miniatures: A Roman and Byzantine
                            Mosaic-Making Workshop</h3>
                        <p class="event-card-meta">May 12 &nbsp; 2:00 PM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue</p>
                    </div>
                    ...
                    <div class="event-card-item">
                        <img src="{{ asset('images/event-research.jpeg') }}" alt="Event Research Out Loud"
                            class="event-card-img" alt="Event">
                        <h3 class="event-card-title">Research Out Loud—Collecting, Presenting, and Conserving at the Met
                        </h3>
                        <p class="event-card-meta">May 14 &nbsp; 10:30 AM</p>
                        <p class="event-card-meta text-gray-400">The Met Fifth Avenue, Online</p>
                    </div>
                </div>
            </section>
