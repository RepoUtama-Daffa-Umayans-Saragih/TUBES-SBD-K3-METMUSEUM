    ...
    <div class="admin-section">
        ...
        <div class="admin-detail-header">
            ...
            <div class="detail-actions">
                <a href="{{ route('admin.object-types.edit', $objectType) }}" class="btn btn-primary">Edit</a>
                <a href="{{ route('admin.object-types.index') }}" class="btn btn-secondary">Back</a>
            </div>
        </div>

        <div class="admin-detail-container">
            <div class="detail-card">
                <h3 class="detail-card-title">Object Type Information</h3>
                <div class="detail-content">
                    <div class="detail-row">
                        <div class="detail-label">Object Type Name</div>
                        <div class="detail-value">{{ $objectType->object_type_name }}</div>
                    </div>
                    <div class="detail-row">
                        <div class="detail-label">Total Artworks</div>
                        <div class="detail-value">{{ $objectType->artWorks->count() }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-card">
                ...
                <div class="detail-content">
                    @if ($objectType->artWorks->count())
                        <table class="admin-table">
                            <thead>
                                <tr><th>Title</th><th>Accession</th><th>Actions</th></tr>
                            </thead>
                            <tbody>
                                @foreach ($objectType->artWorks as $artwork)
                                    <tr>
                                        <td>{{ $artwork->title }}</td>
