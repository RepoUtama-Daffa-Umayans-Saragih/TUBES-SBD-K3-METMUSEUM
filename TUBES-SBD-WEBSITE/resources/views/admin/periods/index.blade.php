...
@section('content')
    <div class="admin-section">
        ...
        <div class="admin-header">
            ...
            <a href="{{ route('admin.periods.create') }}" class="btn-primary">+ Create Period</a>
        </div>
        ...
        <div class="admin-table-container">
                    ...
                    <tbody>
                        @foreach ($periods as $period)
                            <tr>
                                ...
                                <td><span class="badge">{{ $period->art_works_count }}</span></td>
                                <td class="admin-actions">
                                    <a href="{{ route('admin.periods.show', $period) }}" class="btn-sm btn-info">View</a>
                                    <a href="{{ route('admin.periods.edit', $period) }}" class="btn-sm btn-warning">Edit</a>
            ...
            @else
                <div class="admin-empty-state">
                    ...
                    <a href="{{ route('admin.periods.create') }}" class="btn-primary">Create First</a>
                </div>
            @endif
        </div>
    </div>
