...
@section('content')
    <div class="admin-section">
        ...
        <div class="admin-header">
            ...
            <a href="{{ route('admin.materials.create') }}" class="btn-primary">+ Create Material</a>
        </div>
        ...
        <div class="admin-table-container">
                    ...
                    <tbody>
                        @foreach ($materials as $material)
                            <tr>
                                ...
                                <td><span class="badge">{{ $material->art_works_count }}</span></td>
                                <td class="admin-actions">
                                    <a href="{{ route('admin.materials.show', $material) }}" class="btn-sm btn-info">View</a>
                                    <a href="{{ route('admin.materials.edit', $material) }}" class="btn-sm btn-warning">Edit</a>
            ...
            @else
                <div class="admin-empty-state">
                    ...
                    <a href="{{ route('admin.materials.create') }}" class="btn-primary">Create First</a>
                </div>
            @endif
        </div>
    </div>
