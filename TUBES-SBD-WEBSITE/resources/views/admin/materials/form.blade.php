...
@section('content')
    <div class="admin-section">
        ...
        <div class="admin-form-container">
            <form action="{{ $isEdit ? route('admin.materials.update', $material) : route('admin.materials.store') }}" method="POST" class="admin-form">
                @csrf
                @if ($isEdit) @method('PUT') @endif

                <div class="form-group">
                    <label for="material_name" class="form-label">Material Name <span class="required">*</span></label>
                    <input type="text" id="material_name" name="material_name" class="form-control @error('material_name') is-invalid @enderror"
