    ...
    <div class="admin-section">
        ...
        <div class="admin-detail-header">
            ...
            <div class="detail-actions">
                <a href="{{ route('admin.cultures.edit', $culture) }}" class="btn btn-primary">Edit</a>
                <a href="{{ route('admin.cultures.index') }}" class="btn btn-secondary">Back</a>
            </div>
        </div>

        <div class="admin-detail-container">
            <div class="detail-card">
                <h3 class="detail-card-title">Culture Information</h3>
                <div class="detail-content">
                    <div class="detail-row">
                        <div class="detail-label">Culture Name</div>
                        <div class="detail-value">{{ $culture->culture_name }}</div>
                    </div>
                    <div class="detail-row">
                        <div class="detail-label">Total Artworks</div>
                        <div class="detail-value">{{ $culture->artWorks->count() }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-card">
                ...
                <div class="detail-content">
                    @if ($culture->artWorks->count())
                        <table class="admin-table">
                            <thead>
                                <tr><th>Title</th><th>Accession</th><th>Actions</th></tr>
                            </thead>
                            <tbody>
                                @foreach ($culture->artWorks as $artwork)
                                    <tr>
                                        <td>{{ $artwork->title }}</td>
